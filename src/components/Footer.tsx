  ...
  return (
    <footer className="bg-[#F5F5F7] border-t border-[#E5E5E7] text-[#1D1D1F] mt-20">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* Trust Bar */}
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 py-12 border-b border-[#E5E5E7]">
          {[
            {
              icon: Truck,
            ...
            },
            {
              ...
              desc: 'Pay in installments or get 3% Daily Cash back.',
            },
            {
              icon: ShieldCheck,
        ...
        {/* 4-Column Footer */}
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-10 py-14 border-b border-[#E5E5E7]">
          ...
          <div className="flex flex-col items-start space-y-3">
            ...
            <div className="flex items-center gap-4 text-gray-500 pt-2">
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#0066CC] hover:scale-110 transition-all" title="Instagram">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#0066CC] hover:scale-110 transition-all" title="Twitter">
                <Twitter className="w-5 h-5" />
              </a>
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#0066CC] hover:scale-110 transition-all" title="Facebook">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="hover:text-[#0066CC] hover:scale-110 transition-all" title="YouTube">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-[14px] text-gray-600">
              ...
              <li><a href="#" className="hover:text-[#0066CC] transition-colors">Trade-In &amp; Offers</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-3">
            ...
            <a 
              ...
              className="flex items-start gap-2 text-[13px] text-gray-600 hover:text-[#0066CC] transition-colors group leading-relaxed"
              title="Open location in Google Maps"
            >
              <MapPin className="w-4 h-4 text-[#0066CC] shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
            ...
            <div className="pt-1">
              <a href="tel:08143270982" className="inline-flex items-center gap-2 text-[14px] font-semibold text-[#0066CC] hover:underline">
